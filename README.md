...
当前正式版本：[v0.5.1](https://github.com/wcpe/ServerProbe/releases/tag/v0.5.1)。项目坚持只读采集与默认安全：可选增强默认关闭，失败时降级，不应影响服务器或其他插件启动。
...
1. 从 [GitHub Releases](https://github.com/wcpe/ServerProbe/releases) 下载最新的 `ServerProbe-<版本>.jar`（当前 v0.5.1）。
