...
public final class TickSample {
    /** 最近 1 分钟平均 TPS;N/A 时为 null。 */
    Double tps1m;
    /** 最近 5 分钟平均 TPS;N/A 时为 null。 */
    Double tps5m;
    /** 最近 15 分钟平均 TPS;N/A 时为 null。 */
    Double tps15m;
    /** MSPT 平均值(毫秒);N/A 时为 null。 */
    Double msptAvg;
    /** MSPT p95 分位(毫秒);N/A 时为 null。 */
    Double msptP95;
    /** MSPT p99 分位(毫秒);N/A 时为 null。 */
    Double msptP99;
    /** 本次采样的数据来源。 */
    TickSampleSource source;
}
